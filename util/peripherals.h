...
// Install ISR service
#define PIN_PULSE GPIO_NUM_21

#if defined PIN_BUTTON_STANDBY || defined PIN_SENSOR_VEXT || defined PIN_SENSOR_CHARGING || defined PIN_PULSE

	#define INSTALL_ISR_SERVICE true
	#define GPIO_INPUT_PIN_SEL  (1ULL<<PIN_PULSE)
	#define ESP_INTR_FLAG_DEFAULT 0
#endif

///// Output pins
#define GPIO_OUTPUT_IO_TOGGLE_0    GPIO_NUM_18
#ifdef GPIO_OUTPUT_IO_TOGGLE_0
	#define GPIO_OUTPUT_PIN_SEL  (1ULL<<GPIO_OUTPUT_IO_TOGGLE_0)
#endif
